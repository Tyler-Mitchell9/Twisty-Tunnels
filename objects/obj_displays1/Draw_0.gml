...
draw_text(camera_x + 75, camera_y + 30, ":" + string(obj_character1.c1_health)); // Display health

draw_sprite(spr_item1, -1, camera_x + 40, camera_y + 120); // Display coin sprite
draw_text(camera_x + 75, camera_y + 110, ":" + string(obj_character1.coins)); // Display coin count